...
# 27 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/mm_malloc.h" 3 4
...
# 28 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/mm_malloc.h" 2 3 4
...
# 1327 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/emmintrin.h" 3 4
extern __inline __m128i __attribute__((__gnu_inline__, __always_inline__, __artificial__))
...
# 1390 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/emmintrin.h" 3 4
extern __inline void __attribute__((__gnu_inline__, __always_inline__, __artificial__))
...
void compute() {
 ...
 t0 = wtime();
# 124 "coursework.c"
    for (i = 0; i < V; i += 4) { __m128 x_ = _mm_load_ps(x+i); __m128 vx_ = _mm_load_ps(vname+i);
    for (i = 0; i < V; i++) {
        y[i] += dt * vy[i];
        z[i] += dt * vz[i];
